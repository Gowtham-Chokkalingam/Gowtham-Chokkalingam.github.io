...
const About = () => {
  return (
    <div
      name="about"
      className="px-10 md:flex  flex-cols items-center justify-center w-[100%] mx-auto h-full bg-gradient-to-b from-gray-800 to-black text-white "
    >
      ...
      <div className=" mx-auto flex flex-col justify-center w-[100%] md:w-[70%] h-full ">
        ...
        <p className="text-l mt-0 text-justify">
