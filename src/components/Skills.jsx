  ...
  return (
    <div name="skills" className="bg-gradient-to-b from-gray-800 to-black pt-16 w-full h-full">
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white ">
        <div>
          <p className="text-4xl font-bold border-b-4 border-gray-500 p-2 inline hover:border-blue-500 duration-300"><FiSettings className="inline mr-2 mb-2 animate-spin-slow text-blue-400"></FiSettings> Technical Skills</p>
