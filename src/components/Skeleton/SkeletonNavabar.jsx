...
const SkeletonNavabar = () => {
  return (
   ...
   Navbar Loading....<HiDotsHorizontal className="animate-pulse"></HiDotsHorizontal>   <AiOutlineLoading3Quarters className="animate-spin-slow "></AiOutlineLoading3Quarters>
    </div>
  );
};
